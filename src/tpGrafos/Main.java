...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Solucion solucion = mapa.encontrarCamino(azul, ayacucho);
		...
		//Solucion solucion = mapa.encontrarCamino(rauch, mardelplata);
		//System.out.print(solucion);
		//------------------------------------------------------------------------------------------------------------//
		...
		//Solucion solucion = mapa.encontrarCamino(mardelplata, pehuajo);
		//System.out.print(solucion);
		//------------------------------------------------------------------------------------------------------------//
		...
		//mapa.borrarRuta(ayacucho, tandil);
		//------------------------------------------------------------------------------------------------------------//
